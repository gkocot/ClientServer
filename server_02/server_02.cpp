...
int __cdecl main(void)
{
    ...
    //gkocot TBD: Is this needed? SSL_CTX_set_ecdh_auto(ctx, 1);
#if 1
    ...
    printf("OK: SSL_CTX_use_certificate_file\n");

    if (SSL_CTX_use_PrivateKey_file(ctx, "key.pem", SSL_FILETYPE_PEM) <= 0) {
        ERR_print_errors_fp(stderr);
        exit(EXIT_FAILURE);
    }
    printf("OK: SSL_CTX_use_PrivateKey_file\n");
#endif
    WSADATA wsaData;
    int iResult;
    ...
    if (0 == SSL_set_fd(ssl, (int)ClientSocket)) {
